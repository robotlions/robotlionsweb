...
export const atomicPressDataCards = (
  <div className="row">
        ...
        <div className="row">
          ...
          <div className="col-5 d-flex flex-column align-self-center">
            <div className="card-body" style={{ paddingLeft: 0 }}>
              ...
              <p className="card-text">
                Original graphics inspired by 1950s atomic design.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="row">
          ...
          <div className="col-5 d-flex flex-column align-self-center">
            <div className="card-body" style={{ paddingLeft: 0 }}>
              ...
              <p className="card-text">
                Scroll through a list of saved, editable recipes.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="row">
          ...
          <div className="col-5 d-flex flex-column align-self-center">
            <div className="card-body" style={{ paddingLeft: 0 }}>
              ...
              <p className="card-text">
                Users randomly generate coffee recipes then save locally. No
