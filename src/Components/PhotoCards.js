...
const photoObjects ={
    ...
    splashBWCard:{
      ...
      caption: "If I were Richard Dreyfuss' character from Close Encounters, water drop photography would be my mountain of mashed potatoes."
    },
    wineSplashCard: {
      src: wineSplash,
...
export const PhotoGallery = (props) =>{
  ...
  return(
Object.values(photoObjects).map((item, index)=><div key={index} className="photoPanel col-md-3"><PhotoCard src={item.src} alt={item.alt} caption={item.caption}/></div>
))};