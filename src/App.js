    ...
    <div className="container">
          ...
          <Accordion.Body>
            <div className="row contentRow justify-content-center">
              <div className="textField col-md-8">
                <button
                  onClick={() =>
                    setAtomicDataCardsVisible(!atomicDataCardsVisible)
                  }
                >
                  {!atomicDataCardsVisible
                    ? atomicPressCard
                    : atomicPressDataCards}
                </button>
              </div>
        ...
        <Accordion.Body>
              <div className="row contentRow justify-content-center">
                <div className="textField col-md-8">
                  ...
                  {/* <a
                    style={{ color: "black", fontWeight: "bold" }}
                    href="https://twitter.com/LionsRobot"
                  >
                    Twitter
                  </a> */}
                </div>
      ...
      <div className="row brandRow text-end fixed-bottom">
        <p className="linkLogos">
          ...
          {"\n"}
          {/* <a id="twitterLogo" href="https://www.twitter.com/lionsrobot">
            {twitterIcon}
          </a>
          {"\n"} */}
